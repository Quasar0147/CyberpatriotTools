...
$GPO_Win10_BitLocker = "MSFT Windows 10 2004 - BitLocker"
$GPO_Win10_Computer  = "MSFT Windows 10 2004 - Computer"
$GPO_Win10_User      = "MSFT Windows 10 2004 - User"
$GPO_All_DefenderAV  = "MSFT Windows 10 2004 and Server 2004 - Defender Antivirus"
$GPO_All_DomainSec   = "MSFT Windows 10 2004 and Server 2004 - Domain Security"
$GPO_CredentialGuard = "MSFT Windows 10 2004 and Server 2004 Member Server - Credential Guard"
$GPO_WS_DC           = "MSFT Windows Server 2004 - Domain Controller"
$GPO_WS_DC_VBS       = "MSFT Windows Server 2004 - Domain Controller Virtualization Based Security"
$GPO_WS_Member       = "MSFT Windows Server 2004 - Member Server"
