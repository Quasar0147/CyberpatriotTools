...
loginConf() {
	...
	"Ubuntu")
        ...
        echo " uss: [$MainUser]# Creating /etc/lightdm/lightdm.conf for 12.04 compatability." >> output.log
...
echo " uss: [$MainUser]# Editing the ../50-ubuntu.conf for ubuntu 14.04" >> output.log
...
echo " uss: [$MainUser]# Samba has been removed." >> output.log
    ...
    echo "If you just did ssh then you need to run config in beirman"
    fi
    done
...
cron() {
    ...
    read -p "Next up is opening crontabs in nano so you can inspect and remove (or add) cron jobs"
    sudo nano -p /etc/*crontab
    sudo nano -p /etc/*cron*/*
...
Permissions(){
    ...
    clear
    find / -type f -perm 777 >> Script.log
    find / -type f -perm 776 >> Script.log
    find / -type f -perm 775 >> Script.log
    find / -type f -perm 774 >> Script.log
    find / -type f -perm 773 >> Script.log
    find / -type f -perm 772 >> Script.log
    find / -type f -perm 771 >> Script.log
    find / -type f -perm 770 >> Script.log
    find / -type f -perm 767 >> Script.log
    find / -type f -perm 766 >> Script.log
    find / -type f -perm 765 >> Script.log
    find / -type f -perm 764 >> Script.log
    find / -type f -perm 763 >> Script.log
    find / -type f -perm 762 >> Script.log
    find / -type f -perm 761 >> Script.log
    find / -type f -perm 760 >> Script.log
    find / -type f -perm 757 >> Script.log
    find / -type f -perm 756 >> Script.log
    find / -type f -perm 755 >> Script.log
    find / -type f -perm 754 >> Script.log
    find / -type f -perm 753 >> Script.log
    find / -type f -perm 752 >> Script.log
    find / -type f -perm 751 >> Script.log
    find / -type f -perm 750 >> Script.log
    find / -type f -perm 747 >> Script.log
    find / -type f -perm 746 >> Script.log
    find / -type f -perm 745 >> Script.log
    find / -type f -perm 744 >> Script.log
    find / -type f -perm 743 >> Script.log
    find / -type f -perm 742 >> Script.log
    find / -type f -perm 741 >> Script.log
    find / -type f -perm 740 >> Script.log
    find / -type f -perm 737 >> Script.log
    find / -type f -perm 736 >> Script.log
    find / -type f -perm 735 >> Script.log
    find / -type f -perm 734 >> Script.log
    find / -type f -perm 733 >> Script.log
    find / -type f -perm 732 >> Script.log
    find / -type f -perm 731 >> Script.log
    find / -type f -perm 730 >> Script.log
    find / -type f -perm 727 >> Script.log
    find / -type f -perm 726 >> Script.log
    find / -type f -perm 725 >> Script.log
    find / -type f -perm 724 >> Script.log
    find / -type f -perm 723 >> Script.log
    find / -type f -perm 722 >> Script.log
    find / -type f -perm 721 >> Script.log
    find / -type f -perm 720 >> Script.log
    find / -type f -perm 717 >> Script.log
    find / -type f -perm 716 >> Script.log
    find / -type f -perm 715 >> Script.log
    find / -type f -perm 714 >> Script.log
    find / -type f -perm 713 >> Script.log
    find / -type f -perm 712 >> Script.log
    find / -type f -perm 711 >> Script.log
    find / -type f -perm 710 >> Script.log
    find / -type f -perm 707 >> Script.log
    find / -type f -perm 706 >> Script.log
    find / -type f -perm 705 >> Script.log
    find / -type f -perm 704 >> Script.log
    find / -type f -perm 703 >> Script.log
    find / -type f -perm 702 >> Script.log
    find / -type f -perm 701 >> Script.log
    find / -type f -perm 700 >> Script.log
    cat Script.log
...
CISAuto(){
    ...
    mkdir /etc/ansible
    chmod 744 /etc/ansible
    chown -R $MainUser /etc/ansible
    mkdir /etc/ansible/roles
    chmod 744 /etc/ansible/roles
    chown -R $MainUser /etc/ansible/roles
    sudo sh -c "echo '- src: https://github.com/florianutz/Ubuntu2004-CIS.git' > /etc/ansible/requirements.yml"
    cd /etc/ansible/
    sudo ansible-galaxy install -p /etc/ansible -r /etc/ansible/requirements.yml -c local
    sudo ansible-galaxy install git+https://github.com/florianutz/Ubuntu2004-CIS.git
    ...
    nano /etc/ansible/Ubuntu2004-CIS/defaults/main.yml
...
STIGAuto(){
    ...
    cd /etc/ansible/
    sudo ansible-galaxy install -p /etc/ansible -r /etc/ansible/requirements.yml -c local
    sudo ansible-galaxy install git+https://github.com/beholdenkey/ansible-role-ubuntu
    ...
    nano /etc/ansible/ansible-role-ubuntu2004-stig/blob/devel/defaults/main.yml
...
show_menu(){
	...
	"Ubuntu")
				...
				echo "           ╚██████╔╝██████╔╝╚██████╔╝██║ ╚████║   ██║   ╚██████╔╝         "
				echo "            ╚═════╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═══╝   ╚═╝    ╚═════╝          "
				echo "~~~~~~~~~~~~Written by: Ethan Fowler Team-ByTE and Beirman M~~~~~~~~~~~~~~"
                		echo "~~~~~~~~~~~~~~~~Modified by: Nakul Choudhary 2026 Gang~~~~~~~~~~~~~~~~~~~~"
				echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
				echo " "
				...
				echo "23) Beirman               	24) Exit"
                		echo "25) To do list(Other stuff)   	26) Run full (In dev)"
                		echo "27) File search   	        28) Antivirus and defense"
                		echo "29) Network/smb shares            30) UID change"
                		echo "31) Lynis(28 required)            32) Scan for virus"
                		echo "33) Apps & services & auditing    34) Manual file check"
                		echo "35) SysConf                       36) Firefox configuration (In testing)"
                		echo "37) Add user to group             38) Remove user from group"
                		echo "39) Lock users                    40) Permissions"
                		echo "41) Kernel Upgrade                42) Boot Load(In testing)"
                		echo "43) File move for configuring     44) linPEAS (In testing)"
                		echo "45) Encryption (In testing)       46) Lock root"
                		echo "47) See running programs (good for finding viruses)"
                		echo "48) Read logs                     49) CIS (more in testing)"
                		echo "50) STIG, very in testing         51) Fix apt (in testing)"
	;;
	"Debian")
				echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
				echo "		 ██████╗ ███████╗██████╗  █████╗ ██╗███╗   ██╗			"
...
read_options(){
	...
	"Ubuntu"|"Debian")
		...
		18) nc;;
	 	19) reboot;;
		20) secRoot;;
		21) cat postScript; read -p "Press [Enter] key to continue...";;
		22) CAD;;
            	23) Beirman;;
		24) exit 1;;
        	25) To-DoList;;
		26)runFull;;
            	...
            	45) encryption;;
            	46) DisableRoot;;
            	47) compgen -c; read -p "Press [Enter] key to continue...";;
            	48) ReadLogs;;
            	49) CISAuto;;
            	50) STIGAuto;;
            	51) AptFix;;
