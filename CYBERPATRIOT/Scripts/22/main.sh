...
apt-get purge aisleriot gnome-sudoku mahjongg ace-of-penguins gbrainy gnome-sushi gnome-taquin gnome-tetravex gnome-robots gnome-chess lightsoff swell-foop quadrapassel -y >> /dev/null && apt-get autoremove >> /dev/null
