...
function Show-Menu
{
    ...
    Clear-Host
    Write-Host "-============================-[ $Title ]-============================-"
    Write-Host "1: Services                         2: Firewall Settings"
    Write-Host "3: UDP & TCP ports disabled         4: Whole lotta automation"
    Write-Host "5: User Management/Change password  6: Nakul said this is good (SFC)"
    Write-Host "7: Unistall programs                8: Finding files"
    Write-Host "9: Policies                         10: Netstat (Listening Ports)"
    Write-Host "11: Manage entries on Host File     12: List Files Within Directory"
    Write-Host "13: List Scheduled Tasks/Outputs    69: QUIT"
}

do
{
    Show-Menu -Title "2026 GANG WINDOWS SCRIPT (sen is so hot no cap)"
    $UserInput = Read-Host "'Choose which option to do"
    switch ($UserInput)
    {
        '1' {    #Set Services
        ...
        '4' {
            ...
            servermanager
            Write-Output "Remove Features"
            Write-Output "Remove Roles"
            ...
            Write-Output "netstat info in netstat.txt"
            Read-Host -Prompt "Press enter to continue"

            #Open control panel applets for extra configuration
            Write-Output "A bunch of control panel applets are set to open after this"
            read-host -prompt "Press enter to continue"
            ...
            Write-Output "Check the hosts file"

            #Check for updates
            Write-Output "Begin updates"
        ...
        '5' {
            ...
            foreach ($Username in $Usernames) {
                net user $Username.Name Baher13@costco /passwordreq:yes /logonpasswordchg:yes | out-null }
        ...
        '7' {
            ...
            Write-Output "Uninstall programs"
            Read-Host -Prompt "Press enter to continue"
        ...
        '11' {
            ...
            function Write-hosts([string]$filename) {
                $c = Get-Content $filename
        ...
        '12' {
            #List Files
            $Location = Read-Host -Prompt "Which File Folder"
            Get-ChildItem -Force C:\Users\Default\$Location | Out-File -filepath C:\Users\Default\Desktop\process.txt
        }
        '13' {
