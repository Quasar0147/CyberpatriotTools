...
echo " uss: [$MainUser]# Installing Craklib..." >> output.log
	apt-get install libpam-cracklib

echo " uss: [$MainUser]# Cracklib installed." >> output.log
...
echo " uss: [$MainUser]# Samba has been removed." >> output.log
    ...
    cp /etc/pam.d/common-auth /home/$MainUser/backups/
    cp /etc/pam.d/common-password /home/$MainUser/backups/
